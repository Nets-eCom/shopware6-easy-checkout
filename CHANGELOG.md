...
- fix: prevent empty references for promotional items
...
- fix: incompatibility with a security plugin

### Version 2.1.5 - Released 2026-06-03

- docs: update documentation
- chore: extend platform tag
